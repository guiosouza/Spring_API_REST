...
public class SalesProjectApplication implements CommandLineRunner {
	...
	@Autowired
	private SalesRepository productRepository;
	...
	public void run(String... args) throws Exception {
		...
		Sales v1 = new Sales(null, sdf.parse("25/12/2021"), 1200.00, seller1.getName(), seller1);
		Sales v2 = new Sales(null, sdf.parse("25/12/2021"), 2200.00, seller2.getName(), seller2);
		Sales v3 = new Sales(null, sdf.parse("25/12/2021"), 2200.00, seller1.getName(), seller1);
		Sales v4 = new Sales(null, sdf.parse("25/12/2021"), 2200.00, seller2.getName(), seller2);
		...
		productRepository.save(v1);
		productRepository.save(v2);
		productRepository.save(v3);
		productRepository.save(v4);
